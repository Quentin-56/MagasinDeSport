...
public class VisiterRayonControleur implements Initializable {
    @FXML
    private TableView<Article> tableauArticles;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        ...
        tableauArticles.getSelectionModel().selectedItemProperty().addListener(
    ...
    public void remplirTableauDArticles()
    {
        ...
        tableauArticles.setItems(filtreProduits);
    }
    ...
    public void editerFormulaire(String titre, boolean bool) throws IOException {
        Article article = tableauArticles.getSelectionModel().getSelectedItem();
        ...
        controleur.setVisiterRayonControleur(this);
    ...
    public void cliqueSurModifier(ActionEvent actionEvent) throws IOException {
        ...
        if(tableauArticles.getSelectionModel().getSelectedItem() == null)
        {
